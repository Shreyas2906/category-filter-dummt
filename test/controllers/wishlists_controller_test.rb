...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { product_id: @wishlist.product_id, wishlist_id: @wishlist.wishlist_id } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { product_id: @wishlist.product_id, wishlist_id: @wishlist.wishlist_id } }
